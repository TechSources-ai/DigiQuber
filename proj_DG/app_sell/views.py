...
# from .services import get_sell_quote, execute_sell_order
...
#         messages.error(request, "Billing address missing")
#         return redirect("sell_page")
...
#         rate_per_gram=Decimal(quote_resp["rate_per_gram"]),
#         requested_qty=quantity,
#         expires_at=quote_resp["expires_at"]
#     )

#     final_amount = (sell_quote.rate_per_gram * quantity).quantize(Decimal("0.01"))
...
#             resp, total_amount = execute_sell_order(
#                 session_id=session_id,
#                 profile=profile,
#                 quote=quote
#             )

#             balance.bal_quantity -= quote.requested_qty
#             balance.save(update_fields=["bal_quantity"])
...
#                 amount=total_amount,
#                 quote=quote,
#                 mmtc_txn_ref=resp["data"]["orderId"]["transactionId"],
#                 status="SUCCESS"
#             )
...
#             # -------------------------------------------------
#             # 4️⃣ 🔥 VALIDATE SELL QUOTE (Partner PG – MANDATORY)
#             # -------------------------------------------------
#              # -------------------------------------------------
#             # 4️⃣ VALIDATE SELL (Partner PG)
#             # -------------------------------------------------
...
#             txn_id = resp["data"]["orderId"]["transactionId"]
#             total_amount = Decimal(resp["data"]["totalAmount"])

#             # -------------------------------------------------
#             # 6️⃣ Update vault balance
#             # -------------------------------------------------
#             balance.bal_quantity = (
#                 Decimal(balance.bal_quantity) - quote.requested_qty
#             )
#             balance.save(update_fields=["bal_quantity"])
...
#             # -------------------------------------------------
#             # 9️⃣ Ledger entry (history)
#             # -------------------------------------------------
#             # Quote.objects.create(
#             #     customerRefNo=profile.customerRefNo,
#             #     transactionType="SELL",
#             #     currencyPair=currency_pair,
#             #     quantity=Decimal("-1") * quote.requested_qty,
#             #     unitPriceAmt=quote.rate_per_gram,
#             #     preTaxAmt=total_amount,
#             #     totalAmt=total_amount,
#             #     quoteId=quote.quote_id,
#             #     transactionOrderID=txn_id,
#             #     isValidated=True,
